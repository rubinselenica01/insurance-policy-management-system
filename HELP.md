...
* The original package name 'com.rubin.insurance.policy-management-service' is invalid and this project uses 'com.rubin.insurance.policy_management_service' instead.
